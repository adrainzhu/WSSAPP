...
public class Out_WLScanAdapter extends ArrayAdapter<Out_Scan> {
private List<Out_Scan> myitems=null;
    private Context mycontext = null;
    public Out_WLScanAdapter(@NonNull Context context, int resource , @NonNull List<Out_Scan> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.outwlscan, parent, false);
