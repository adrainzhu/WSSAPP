...
public class Out_LotWLDetailAdapter extends ArrayAdapter<Out_LotDetail> {
    List<Out_LotDetail> items;
    public Out_LotWLDetailAdapter(@NonNull Context context, int resource, @NonNull List<Out_LotDetail> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView wldhlview = view.findViewById(R.id.material);
        ...
        wldhlview.setText(item.getWuliuNo());
